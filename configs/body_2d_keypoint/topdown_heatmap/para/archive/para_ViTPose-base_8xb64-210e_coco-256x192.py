...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode=data_mode,
        ann_file='annotations/person_keypoints_val_para.json',
        # ann_file='annotations/person_keypoints_val_para_test1.json',
        data_prefix=dict(img='ParaAthelet/'),
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/person_keypoints_val_para.json')
